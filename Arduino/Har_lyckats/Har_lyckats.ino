...
int DegreeMinimum = 0, DegreeMitten = 75, DegreeMax = 130, turnDelay, Degree, ServoDelay = 1000;
int StartSleep = 1500, ButtonState = 0;
int DistanceL, DistanceF, DriveTime, DriveDistanceGGR = 75, Acc = 750;
int MinstaL, MinstaF, HogstaL, HogstaF, AllDistanceL, AllDistanceF;
int SweetSpotL = 15, SweetSpotFHigh = 15, SweetSpotFLow = 14;
